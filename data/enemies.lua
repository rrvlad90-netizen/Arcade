return {
   	Bat = require("data.enemies.bat"),
   	BatBomber = require("data.enemies.bat_bomber"),
	FlyingShooter = require("data.enemies.flying_shooter"),
	...
	AimedDragon = require("data.enemies.aimeddragon")
}
